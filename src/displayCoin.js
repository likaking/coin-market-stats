...
index < render &&     <div key={itemz.id+index} ref = {(el)=> container.current[index]=el} className={styles.dipedCrypto_R_container}  onMouseEnter = {()=>hoverIn(index)} onMouseLeave = {()=>hoverOut(index)}  > 
	...
	<div className={styles.dipedCrypto_R_container_hourlyChange} style={{color: Number(itemz.price_change_percentage_1h_in_currency) < 0 ?'red' : 'rgb(28, 187, 44)'}}><FaCaretDown style={{display: Number(itemz.price_change_percentage_1h_in_currency) < 0?'block' : 'none' }}  className={styles.dipedCrypto_R_faCaretUp} /> <FaCaretUp style={{display: Number(itemz.price_change_percentage_1h_in_currency) >= 0 ? 'block' : 'none'  }} className={styles.dipedCrypto_R_faCaretUp} />{Number(itemz.price_change_percentage_1h_in_currency) < 0 ? Number(itemz.price_change_percentage_1h_in_currency).toFixed(1).slice(1) : Number(itemz.price_change_percentage_1h_in_currency).toFixed(1)}</div> 
	<div className={styles.dipedCrypto_R_container_24hChange} style={{color: Number(itemz.price_change_percentage_24h_in_currency) < 0 ?'red' : 'rgb(28, 187, 44)'}}><FaCaretDown style={{display: Number(itemz.price_change_percentage_24h_in_currency) < 0?'block' : 'none' }}  className={styles.dipedCrypto_R_faCaretUp} /> <FaCaretUp style={{display: Number(itemz.price_change_percentage_24h_in_currency) >= 0 ? 'block' : 'none'  }} className={styles.dipedCrypto_R_faCaretUp} />{Number(itemz.price_change_percentage_24h_in_currency) < 0 ? Number(itemz.price_change_percentage_24h_in_currency).toFixed(1).slice(1) : Number(itemz.price_change_percentage_24h_in_currency).toFixed(1)}</div> 
	<div className={styles.dipedCrypto_R_container_7d} style={{color: Number(itemz.price_change_percentage_7d_in_currency) < 0 ?'red' : 'rgb(28, 187, 44)'}}><FaCaretDown style={{display: Number(itemz.price_change_percentage_7d_in_currency) < 0?'block' : 'none' }}  className={styles.dipedCrypto_R_faCaretUp} /> <FaCaretUp style={{display: Number(itemz.price_change_percentage_7d_in_currency) >= 0 ? 'block' : 'none'  }} className={styles.dipedCrypto_R_faCaretUp} />{Number(itemz.price_change_percentage_7d_in_currency) < 0 ? Number(itemz.price_change_percentage_7d_in_currency).toFixed(1).slice(1) : Number(itemz.price_change_percentage_7d_in_currency).toFixed(1)}</div> 
